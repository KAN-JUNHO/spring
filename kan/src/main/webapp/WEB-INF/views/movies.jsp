...
<body class style="zoom: 1;">
    ...
    <div id="footer">
        <div id="BottomWrapper" class="sect-ad">
            <iframe src="http://adimg.cgv.co.kr/images/201709/house/0929_980X240.png" width="100%" height="240" title="광고-CGV 기프트 카드" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" name="Bottom" id="Bottom">
        </div>
        <div class="foot">
