...
<head>
    ...
    <meta id="og_title" property="og:title" content="영화 그 이상의 감동. CGV"></meta>
    <meta id="og_image" property="og:image" content="http://img.cgv.co.kr/WebApp/images/common/logo_new_kakao_prevw.png"></meta>
...
<script type="text/javascript" src="https://nsso.cjone.com/findCookieSecured.jsp?cjssoq=j2Q8Oq5j%2b3TpZYdEB715%2f%2bK6ZXac7SCeYwyGMbwr8vTndj5DZQSawSWewkkBqmqkvITugxGvf42kiXiopjAU5i9pdHJHcHoyZE0reGluRlc0aUhFUFdBejlQVWRvVXMxSjdFaU1oRDhaN2VjaVdEUWJaS1ZzbFFkazZ3MlU4dzI%3d"></script>
</head>
    ...
    $closebtn.on('click', function () {
        ...
        <div class="sect-service">
            ...
            <ul class="gnb">
                ...
                <li><a href="/user/login/?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fticket%2fdefault.aspx%3fMOVIE_CD%3d20022936%26MOVIE_CD_GROUP%3d20022889" class="login" ><span>로그인</span></a></li>
...
<div id="contaniner">
    ...
    <iframe title="CGV 빠른예매" id="ticket_iframe" src="http://localhost:8080/kan/Reservation/Reservation?MOVIE_CD=20022936&MOVIE_CD_GROUP=20022889&PLAY_YMD=&THEATER_CD=&PLAY_NUM=&PLAY_START_TM=&AREA_CD=&SCREEN_CD=&THIRD_ITEM=" 
