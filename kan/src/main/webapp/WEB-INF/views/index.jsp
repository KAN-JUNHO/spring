            ...
            $closebtn.on('click', function () {
                ...
                <div class="sect-service">
                    ...
                    <ul class="gnb">
                        ...
                        <li><a href="/user/login/?returnURL=http%3a%2f%2fwww.cgv.co.kr%2fdefault.aspx" class="login">
	                        <span>
    ...
    <div class="sect-common">
        <div class="slider" id="slider">
            <button type="button" class="btn-pause" style="left: 510px; display: block;">일시멈춤</button>
                ...
                <div class="item-wrap">
                    <button type="button" class="" style="left: 456px; display: block;">LET'S PLAY AT CGV!</button>
                    ...
                    <div class="item-wrap on">
                        ...
                        <a class="item" style="width: 980px; height: 450px; display: block;" href="http://www.cgv.co.kr/culture-event/event/detail-view.aspx?idx=20829&amp;menu=0">
