                ...
                <aside>
                    <ul class="sideMenu">
                        ...
                        <li>
                            ...
                            <ol>
                                <li><a href="#">영화현황</a></li>
                                <li><a href="./movie/register.html">영화등록</a></li>                                
                                <li><a href="./movie/schedule.html">영화상영 일정 등록</a></li>                                
                            </ol>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ol>
                                <li><a href="#">티켓현황</a></li>
                                <li><a href="./ticket/generate.html">티켓생성</a></li>                                
                            </ol>
                        </li>
                        <li>
                            ...
                            <ol>
                                ...
                                <li><a href="./theater/register.html">영화관 등록</a></li>
                                <li><a href="./theater/register-screen.html">상영관 등록</a></li>
                            </ol>
                        </li>
                        <li>
